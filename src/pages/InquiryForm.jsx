...
import { Calendar, Clock, Monitor, Award, ArrowRight, Check, Users, Star } from 'lucide-react';
      ...
      <div className="relative z-10 py-8">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="text-center">
            <span className="inline-block bg-green-600 text-white px-4 py-1 rounded-full text-sm font-semibold tracking-wider mb-3">FREE LIVE WORKSHOP • ONE DAY ONLY</span>
        ...
        <div className="w-full lg:w-3/5 space-y-8 lg:pr-16">
          <div className="backdrop-blur-sm bg-black bg-opacity-40 rounded-xl p-6 border border-white border-opacity-10">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-xl font-bold">20th April 2025 • 6:00 PM - 7:00 PM IST</p>
              </div>
            </div>
          ...
          <div className="backdrop-blur-sm bg-black bg-opacity-40 rounded-xl p-6 border border-white border-opacity-10">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="text-green-400">Voice Solution Architect, Tech Mahindra</p>
                <p className="text-sm mt-2 text-gray-300">15+ years of industry experience guiding professionals through career transitions</p>
              </div>
            </div>
          </div>
          ...
          <div className="backdrop-blur-sm bg-green-600 bg-opacity-40 rounded-lg p-4 border border-white border-opacity-10">
            <div className="flex items-center justify-between">
              <div>
                <span className="block text-sm font-medium">Workshop Value:</span>
                <div className="flex items-center">
                  <span className="text-2xl font-bold line-through opacity-70">₹2,999</span>
                  <span className="ml-3 text-3xl font-bold">FREE</span>
                </div>
              </div>
              <div className="text-sm">
                ...
                <span className="font-bold">Register now to secure your spot</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-2/5 mt-10 lg:mt-0 relative z-10">
          <div className="backdrop-blur-md bg-white bg-opacity-90 rounded-2xl shadow-2xl overflow-hidden">
            <div className="bg-green-600 bg-opacity-90 px-6 py-6 text-white">
              ...
              <p className="opacity-90">Secure your spot in this exclusive workshop</p>
            </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    <label className="flex items-center space-x-2 cursor-pointer">
                      <input type="radio" name="interest" value="yes" defaultChecked className="w-4 h-4 text-green-600" />
                      <span className="text-gray-800">Yes</span>
                    </label>
                    <label className="flex items-center space-x-2 cursor-pointer">
                      <input type="radio" name="interest" value="no" className="w-4 h-4 text-green-600" />
        ...
        >
          ...
          <ArrowRight className="ml-2 w-5 h-5" />
                ...
                <p className="text-xs text-gray-500 mt-4">
                  By submitting this form, I agree to be contacted via call, SMS, email or WhatsApp even if I am registered under NDNC. I also agree that I have read and understood the
                  <a href="#" className="text-green-600 hover:underline"> Terms of Service</a> and agree to abide by them.
                </p>
              </form>
            </div>
          </div>
          ...
          <div className="mt-6 backdrop-blur-sm bg-black bg-opacity-40 rounded-xl p-4 border border-white border-opacity-10">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-sm font-medium">Don't miss out! Limited spots available.</p>
            </div>
          </div>
        </div>
      </div>
